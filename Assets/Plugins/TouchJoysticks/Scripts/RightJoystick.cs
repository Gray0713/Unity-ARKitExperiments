...
public class RightJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
	...
	[Tooltip("Height of joystick moving area. Ignored in fixed position.")]
	[Range(0.0f, 100.0f)] public float joystickHeightAreaPercentage = 100.0f;
            ...
            */
            ...
            if (joystickStaysInFixedPosition == false)
            {
                ...
                if (unNormalizedInput.magnitude > inputVector.magnitude)
                {
                    ...
                    //float areaHeight = joystickHeightAreaPercentage / 100.0f;
